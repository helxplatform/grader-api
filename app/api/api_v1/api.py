...
from .endpoints import (assignment_router, auth_router, course_router,
                        health_router, instructor_router, lms_router,
                        settings_router, student_router, submission_router,
                        user_router)
